...
test.describe("E2E test", () => {
  test("should login, create case and run different test cases for Screen flow", async ({
    ...
    const screenflowCase = page.locator(
      'div[role="button"]:has-text("Screenflow")',
    );
    await screenflowCase.click();

    /** Enter details in step1 */
    const firstStepInput = page.locator(
      'input[data-test-id="e8501da981ee0c09b948fb28b0847189"]',
    );
    ...
    const secondStepInput = page.locator(
      'input[data-test-id="77a2c6ab9db81c2394fb761209e89fd4"]',
    );
    ...
    const subFlowStep1 = page.locator(
      'input[data-test-id="b31b8052e912d9609d7b0b35b1503089"]',
    );
    ...
    const subFlowStep2 = page.locator(
      'input[data-test-id="8ca328af70e77d657136025c34d0f4ce"]',
    );
    ...
    const thirdStepInput = page.locator(
      'input[data-test-id="6359b052b0848cf46b32a80f89addeb0"]',
    );
