...
test.describe("E2E test", () => {
  test("should login, create case and run different test cases for User Reference", async ({
    ...
    const searchBoxInputDiv = page.locator(
      'div[data-test-id="75c6db46c48c2d7bb102c91d13ed766e"]',
    );
    const searchBoxInput = searchBoxInputDiv.locator(
    ...
    const user = await page.locator(
      'app-operator span[class="mat-button-wrapper"]',
    ).innerHTML;
