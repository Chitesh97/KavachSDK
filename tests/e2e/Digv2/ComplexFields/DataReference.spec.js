...
test.describe("E2E test", () => {
  test("should login, create case and run different test cases for Data Reference", async ({
    ...
    await expect(
      assignment.locator('input[value="Basic Product"]'),
    ).toBeVisible();
    ...
    selectedProduct = page.locator(
      'div[role="combobox"]:has-text("Basic Product")',
    );
    await selectedProduct.click();
    await page.locator('li:has-text("Basic Product")').click();
    ...
    const selectedProductTestRow = selectedProduct.locator(
      'input[type="checkbox"]',
    );
    await selectedProductTestRow.click();

    selectedProduct = page.locator('tr:has-text("Green Item")');
    const selectedProductTestSecondRow = selectedProduct.locator(
      'input[type="checkbox"]',
    );
    ...
    /** Testing the values present on Confirm screen */
    await expect(
      assignment.locator('tr:has-text("Luxury Product")'),
    ).toBeVisible();
    ...
    let displayAs = page.locator(
      'div[data-test-id="4aa668349e0970901aa6b11528f95223"]',
    );
    ...
    await expect(
      assignment.locator('div[role="button"]:has-text("Mobile")'),
    ).toBeVisible();
    await expect(
      assignment.locator('div[role="button"]:has-text("Television")'),
    ).toBeVisible();

    let deleteProduct = await assignment.locator(
    ...
    deleteProduct = await assignment.locator(
      'div[role="button"]:has-text("Television")',
    );
    await deleteProduct.locator('svg[focusable="false"]').click();

    /** Checkbox group mode type test */
    displayAs = page.locator(
      'div[data-test-id="4aa668349e0970901aa6b11528f95223"]',
    );
    await displayAs.click();
    ...
    await expect(
      assignment.locator('td >> text="Washing Machine"'),
    ).toBeVisible();
    await expect(assignment.locator('td >> text="Mobile"')).toBeVisible();
    ...
    selectedProduct = page.locator(
      'div[id="semantic-link-grid"] >> span >> text="Basic Product"',
    );
    await expect(selectedProduct).toBeVisible();
