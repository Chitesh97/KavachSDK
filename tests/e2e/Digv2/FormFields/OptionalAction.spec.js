...
test.describe("E2E test", () => {
  test("should login, create case and run the Optional Action tests", async ({
    page,
  }) => {
    await common.login(
    ...
    await page
      .locator('li[role="menuitem"]:has-text("Multi Step Test")')
      .click();

    let input = page.locator(
      'input[data-test-id="8ca45623e49263849b3bf9f67c03999f"]',
    );
    ...
    input = page.locator(
      'input[data-test-id="a45879b4fd9831ffbd28fcc759f051a1"]',
    );
