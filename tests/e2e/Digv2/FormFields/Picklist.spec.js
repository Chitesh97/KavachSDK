...
test.describe("E2E test", () => {
  test("should login, create case and run the Email tests", async ({
    page,
  }) => {
    await common.login(
    ...
    /** Dropdown tests */
    const picklistAs = page.locator(
      'div[data-test-id="683ea3aece0dce7e065d31d43f1c269b"]',
    );
    await picklistAs.click();
    await page.getByRole("option", { name: "Dropdown" }).click();

    const dropdown = page.locator(
      'div[data-test-id="94cb322b7468c7827d336398e525827e"]',
    );
    /** Checking 'placeholder' and 'helper text' */
    const placeholderValue = await dropdown
      .locator("input")
    ...
    await expect(
      page.locator(
        'div[id="Assignment"] >> p:has-text("Picklist Helper Text")',
      ),
    ).toBeVisible();
    ...
    const autocomplete = page.locator(
      'div[data-test-id="ed90c4ad051fd65a1d9f0930ec4b2276"]',
    );
