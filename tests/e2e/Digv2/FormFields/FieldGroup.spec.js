...
test.describe("E2E test", () => {
  test("should login, create case and run the Field Group tests", async ({
    page,
  }) => {
    await common.login(
    ...
    const formFieldsCase = page.locator(
    ...
    await expect(
      page.getByText("Instruction text for Field Group"),
    ).toBeVisible();

    await page
      .locator('input[data-test-id="e168c363420fd1c9a8554611faeaf032"]')
      .fill("John Doe");
    await page
      .locator('label[data-test-id="a032469ff9249c2c8b2899b2c9a5dc92"] input')
      .check();

    await page
      .locator('div[data-test-id="768a96ac6004939bb62c0530652bdc7c"]')
      .click();
    ...
    await expect(
      await page
        .locator(
          'div[data-test-id="8e70e124867b68bec5cbf1f2f25da383"] >> div[role="combobox"]',
        )
        .textContent(),
    ).toBe("United States");
