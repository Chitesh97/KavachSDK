...
test.describe("E2E test", () => {
  ...
  test("should login, create case and run the Integer tests", async ({
    page,
  }) => {
    await common.login(
    ...
    await expect(await requiredInteger.getAttribute("placeholder")).toBe(
      "Integer Placeholder",
    );
    await expect(
    ...
    await expect(
      page.locator('div >> p:has-text("Integer HelperText")'),
    ).toBeVisible();
