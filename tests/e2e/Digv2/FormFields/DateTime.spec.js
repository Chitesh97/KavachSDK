...
test.describe("E2E test", () => {
  ...
  test("should login, create case and run the DateTime tests", async ({
    page,
  }) => {
    await common.login(
    ...
    /** Required tests */
    const requiredDateTime = page.locator(
      'div[data-test-id="8c40204d0a4eee26d94339eee34ac0dd"]',
    );
    ...
    const conditionallyDisabledDateTimeInput =
      conditionallyDisabledDateTime.locator("input");
    ...
    /** Update tests */
    const readonlyDateTime = page.locator(
      'input[data-test-id="13858d32e1a9e9065cbef90a4fc4467e"]',
    );
    attributes = await common.getAttributes(readonlyDateTime);
    await expect(attributes.includes("readonly")).toBeTruthy();

    const editableDateTime = page.locator(
      'div[data-test-id="4e5110fbcaf65441b3e4c763907b5eb8"]',
    );
    ...
    const conditionallyVisibleDateTimeInput =
      conditionallyVisibleDateTime.locator("input");
    if (isVisible) {
