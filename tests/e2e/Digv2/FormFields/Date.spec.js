...
test.describe("E2E test", () => {
  ...
  test("should login, create case and run the Date tests", async ({ page }) => {
    ...
    /** Required tests */
    const requiredDate = page.locator(
      'div[data-test-id="4aeccb2d830e2836aebba27424c057e1"]',
    );
    ...
    const notRequiredDate = page.locator(
      'div[data-test-id="3f56f9d617e6174716d7730f8d69cce5"]',
    );
    ...
    // /** Disable tests */
    const alwaysDisabledDate = page.locator(
      'div[data-test-id="058f04d806163a3ea0ad42d63a44bff8"]',
    );
    ...
    const conditionallyDisabledDateInput =
      conditionallyDisabledDate.locator("input");
    ...
    const neverDisabledDate = page.locator(
      'div[data-test-id="3cf7f70f60efb4035b562b6d5994badd"]',
    );
    ...
    const readonlyDate = page.locator(
      'input[data-test-id="ffde26c63aa11b0de746587bc02779ee"]',
    );
    attributes = await common.getAttributes(readonlyDate);
    await expect(attributes.includes("readonly")).toBeTruthy();

    const editableDate = page.locator(
      'div[data-test-id="80f5dcc587f457378158bb305ec858a8"]',
    );
    ...
    const conditionallyVisibleDateInput =
      conditionallyVisibleDate.locator("input");
    if (isVisible) {
