...
test.describe("E2E test", () => {
  ...
  test("should login, create case and run the Boolean tests", async ({
    page,
  }) => {
    await common.login(
    ...
    await expect(
      page.locator('div >> legend:has-text("Required Boolean")'),
    ).toBeVisible();
    await expect(
      page.locator('div >> p:has-text("Required field")'),
    ).toBeVisible();
