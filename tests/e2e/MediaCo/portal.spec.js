...
test.describe("E2E test", () => {
  test("should login, create case and send for discount", async ({ page }) => {
    ...
    const newServiceCase = page.locator(
      'div[role="button"]:has-text("New Service")',
    );
    ...
    const suffix = page.locator(
      'div[data-test-id="56E6DDD1CB6CEC596B433440DFB21C17"]',
    );
    ...
    const serviceDate = page.locator(
      'div[data-test-id="E0BA356AE552ACD4326D51E61F4279AC"]',
    );
    ...
    const state = page.locator(
      'div[data-test-id="46A2A41CC6E552044816A2D04634545D"]',
    );
    ...
    const tvPackage = page.locator(
      'label[data-test-id="0B3244CEB2CE9879260EB560BD7A811E"]',
    );
    ...
    const internetPackage = page.locator(
      'label[data-test-id="C05A1E5DECC321D9792E9A9E15184BE5"]',
    );
    ...
    const phonePackage = page.locator(
      'label[data-test-id="7CF3F86883596E49D8D7298CC5B928A2"]',
    );
    ...
    const sendToMgr = page.locator(
      'label[data-test-id="C3B43E79AEC2D689F0CF97BD6AFB7DC4"]',
    );
  ...
  test("should modify(if required) the actual services/packages to be installed and resolve the case", async ({
    ...
    const tvConnected = page.locator(
      'label[data-test-id="EEF2AA5E42FD9F0FB0A44EA0B2D52921"]',
    );
