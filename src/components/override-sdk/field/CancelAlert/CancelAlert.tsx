...
export default function CancelAlert(props: CancelAlertProps) {
  ...
  const isLocalAction = getPConnect().getValue(
  ...
  function cancelHandler() {
    if (isReverseCoexistence) {
      ...
      PCore.getPubSubUtils().publish(
        PCore.getConstants().PUB_SUB_EVENTS.REVERSE_COEXISTENCE_EVENTS
          .HANDLE_DISCARD,
      );
  ...
  const rightButton = (
    <Button
      ...
      variant="contained"
      color="primary"
      disabled={buttonsState[btnIds.DELETE]}
