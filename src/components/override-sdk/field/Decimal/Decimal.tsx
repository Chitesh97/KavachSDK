...
import {
  ...
  getCurrencyOptions,
} from "@pega/react-sdk-components/lib/components/field/Currency/currency-utils";
...
export default function Decimal(props: DecimalProps) {
  ...
  if (formatter === "Currency") {
    ...
    formattedValue = format(
      value,
      pConn.getComponentName()?.toLowerCase(),
      theCurrencyOptions,
    );
  }
  ...
  if (displayMode === "DISPLAY_ONLY") {
    return (
      <FieldValueList name={hideLabel ? "" : label} value={formattedValue} />
    );
  }
  ...
  return (
    <NumericFormat
      ...
      decimalScale={
        readOnly && formatter === "Currency" ? undefined : decimalPrecision
      }
