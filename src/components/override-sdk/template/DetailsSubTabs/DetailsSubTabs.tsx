...
import {
  ...
  getVisibleTabs,
  tabClick,
} from "@pega/react-sdk-components/lib/components/template/SubTabs/tabUtils";
...
export default function DetailsSubTabs(
  props: PropsWithChildren<DetailsSubTabsProps>,
) {
