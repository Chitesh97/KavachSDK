...
import {
  ...
  filterData,
  getContext,
} from "@pega/react-sdk-components/lib/components/helpers/simpleTableHelpers";
...
export default function SimpleTableManual(
  ...
  const fieldDefs = buildFieldsForTable(
    rawFields,
    resolvedFields,
    showDeleteButton,
  );
      ...
      rawFields.forEach((item) => {
        ...
        item = {
          ...
          config: {
            ...
            label: "",
            displayMode:
              readOnlyMode || allowEditingInModal ? "DISPLAY_ONLY" : undefined,
          },
        };
