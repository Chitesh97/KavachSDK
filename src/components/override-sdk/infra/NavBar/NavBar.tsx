...
import {DataExplorationIcon} from "@mui/icons-material";
...
const iconMap = {
  ...
  'pi pi-search-analytics': <DataExplorationIcon fontSize='large' />
};
        ...
        <List component="div" disablePadding>
          {caseTypes.map((caseType) => (
            ...
            >
              ...
              <ListItemText
                primary={localeUtils.getLocaleValue(
                  caseType.pyLabel,
                  "",
                  localeReference,
                )}
          ...
          >
            <MenuItem onClick={logout}>
              ...
              <Typography variant="inherit">
                {localizedVal("Log off", localeCategory)}
              </Typography>
            </MenuItem>
          </Menu>
        </>
