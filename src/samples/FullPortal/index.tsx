...
export default function FullPortal() {
  ...
  const [rootComponentProps, setRootComponentProps] = useState<object | null>(
    null,
  );
  ...
  function startPortal() {
    ...
    const { appPortal: thePortal, excludePortals } =
      SdkConfigAccess.getSdkConfigServer();
    ...
    if (queryPortal) {
      ...
      myLoadDefaultPortal &&
      defaultPortal &&
      !excludePortals.includes(defaultPortal)
    ) {
